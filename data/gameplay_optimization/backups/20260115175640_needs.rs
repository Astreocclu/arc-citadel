...
impl Needs {
    ...
    pub fn decay(&mut self, dt: f32, is_active: bool) {
        ...
        // Rates tuned for observable emergence in short simulation windows
        self.rest += 0.01 * dt * activity_mult; // Fastest when active
        self.food += 0.005 * dt; // Half of rest rate
        self.social += 0.003 * dt; // Slow social pressure
        self.purpose += 0.002 * dt; // Slowest - aimlessness builds gradually
