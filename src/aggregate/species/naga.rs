...
mod tests {
    ...
    fn create_test_polity() -> Polity {
        Polity {
            id: PolityId(1),
            name: "Test Naga Polity".to_string(),
            ...
            species_state: SpeciesState::Naga(NagaState::default()),
            alive: true,
        }
    }

    #[test]
    fn test_naga_state_accessor() {
        let polity = create_test_polity();
        let state = polity.naga_state();
