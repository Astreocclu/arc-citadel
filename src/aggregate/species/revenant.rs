...
mod tests {
    ...
    fn create_test_polity() -> Polity {
        Polity {
            id: PolityId(1),
            name: "Test Revenant Polity".to_string(),
            ...
            species_state: SpeciesState::Revenant(RevenantState::default()),
            alive: true,
        }
    }

    #[test]
    fn test_revenant_state_accessor() {
        let polity = create_test_polity();
        let state = polity.revenant_state();
