...
mod tests {
    ...
    fn create_test_polity() -> Polity {
        Polity {
            id: PolityId(1),
            name: "Test Dryad Polity".to_string(),
            species: Species::Dryad,
            ...
            species_state: SpeciesState::Dryad(DryadState::default()),
            alive: true,
        }
    }

    #[test]
    fn test_dryad_state_accessor() {
        let polity = create_test_polity();
        let state = polity.dryad_state();
