...
mod tests {
    ...
    fn create_test_polity() -> Polity {
        Polity {
            id: PolityId(1),
            name: "Test AbyssalDemons Polity".to_string(),
            species: Species::AbyssalDemons,
            ...
            species_state: SpeciesState::AbyssalDemons(AbyssalDemonsState::default()),
            alive: true,
        }
    }

    #[test]
    fn test_abyssal_demons_state_accessor() {
        let polity = create_test_polity();
        let state = polity.abyssal_demons_state();
