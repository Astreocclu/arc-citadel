...
mod tests {
    ...
    fn create_test_polity() -> Polity {
        Polity {
            id: PolityId(1),
            name: "Test Elemental Polity".to_string(),
            ...
            species_state: SpeciesState::Elemental(ElementalState::default()),
            alive: true,
        }
    }

    #[test]
    fn test_elemental_state_accessor() {
        let polity = create_test_polity();
        let state = polity.elemental_state();
