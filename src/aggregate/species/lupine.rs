...
mod tests {
    ...
    fn create_test_polity() -> Polity {
        Polity {
            id: PolityId(1),
            name: "Test Lupine Polity".to_string(),
            ...
            species_state: SpeciesState::Lupine(LupineState::default()),
            alive: true,
        }
    }

    #[test]
    fn test_lupine_state_accessor() {
        let polity = create_test_polity();
        let state = polity.lupine_state();
