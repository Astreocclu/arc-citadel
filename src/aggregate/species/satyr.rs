...
mod tests {
    ...
    fn create_test_polity() -> Polity {
        Polity {
            id: PolityId(1),
            name: "Test Satyr Polity".to_string(),
            species: Species::Satyr,
            ...
            species_state: SpeciesState::Satyr(SatyrState::default()),
            alive: true,
        }
    }

    #[test]
    fn test_satyr_state_accessor() {
        let polity = create_test_polity();
        let state = polity.satyr_state();
