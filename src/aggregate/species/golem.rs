...
mod tests {
    ...
    fn create_test_polity() -> Polity {
        Polity {
            id: PolityId(1),
            name: "Test Golem Polity".to_string(),
            ...
            species_state: SpeciesState::Golem(GolemState::default()),
            alive: true,
        }
    }

    #[test]
    fn test_golem_state_accessor() {
        let polity = create_test_polity();
        let state = polity.golem_state();
