...
mod tests {
    ...
    fn create_test_polity() -> Polity {
        Polity {
            id: PolityId(1),
            name: "Test StoneGiants Polity".to_string(),
            species: Species::StoneGiants,
            ...
            species_state: SpeciesState::StoneGiants(StoneGiantsState::default()),
            alive: true,
        }
    }

    #[test]
    fn test_stone_giants_state_accessor() {
        let polity = create_test_polity();
        let state = polity.stone_giants_state();
