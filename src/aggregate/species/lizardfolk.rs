...
mod tests {
    ...
    fn create_test_polity() -> Polity {
        Polity {
            id: PolityId(1),
            name: "Test Lizardfolk Polity".to_string(),
            species: Species::Lizardfolk,
            ...
            species_state: SpeciesState::Lizardfolk(LizardfolkState::default()),
            alive: true,
        }
    }

    #[test]
    fn test_lizardfolk_state_accessor() {
        let polity = create_test_polity();
        let state = polity.lizardfolk_state();
