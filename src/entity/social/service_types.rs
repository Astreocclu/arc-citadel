...
mod tests {
    ...
    fn test_service_from_action() {
        ...
        assert_eq!(ServiceType::from_action(ActionId::Repair), Some(ServiceType::Labor));
        assert_eq!(ServiceType::from_action(ActionId::Defend), Some(ServiceType::Protection));
        assert_eq!(ServiceType::from_action(ActionId::HoldPosition), Some(ServiceType::Protection));
    ...
    fn test_trait_from_action() {
        ...
        assert_eq!(TraitIndicator::from_action(ActionId::Charge), Some(TraitIndicator::Aggressive));
        assert_eq!(TraitIndicator::from_action(ActionId::Defend), Some(TraitIndicator::Reliable));
        assert_eq!(TraitIndicator::from_action(ActionId::HoldPosition), Some(TraitIndicator::Reliable));
        assert_eq!(TraitIndicator::from_action(ActionId::MoveTo), None); // Not a trait indicator
    }

    #[test]
    fn test_trait_opposite() {
        assert_eq!(TraitIndicator::Reliable.opposite(), TraitIndicator::Unreliable);
        assert_eq!(TraitIndicator::Unreliable.opposite(), TraitIndicator::Reliable);
        ...
        assert_eq!(TraitIndicator::Aggressive.opposite(), TraitIndicator::Peaceful);
        assert_eq!(TraitIndicator::Peaceful.opposite(), TraitIndicator::Aggressive);
