...
impl RelationshipMemory {
    ...
    pub fn apply_decay(&mut self, current_tick: u64, decay_rate: f32) {
        ...
        let days_passed =
            (current_tick.saturating_sub(self.tick_created)) as f32 / ticks_per_day as f32;
...
mod tests {
    ...
    fn test_memory_creation() {
        let memory = RelationshipMemory::new(EventType::AidReceived, Valence::Positive, 0.8, 100);
    ...
    fn test_multiple_decay_applications() {
        let mut memory =
            RelationshipMemory::new(EventType::GiftReceived, Valence::Positive, 0.6, 0);
