...
Each module README contains a **Critical Implementation Details** section with gotchas specific to that module:

- `src/simulation/README.md` - Task execution, satisfaction multiplier
- `src/entity/README.md` - Need decay rates, priority ordering, safety asymmetry
