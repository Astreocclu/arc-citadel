...
class FeatureType(str, Enum):
    ...
    TREEHOUSE = "treehouse"
    HANGING_BRIDGE = "hanging_bridge"
    # Natural
    CLEARING = "clearing"
    ANCIENT_TREE = "ancient_tree"
    GROVE = "grove"
    ROCK_FORMATION = "rock_formation"
    FUNGAL_GARDEN = "fungal_garden"
    # Underground - Dwarf
    ...
    ANVIL = "anvil"
    SMELTER = "smelter"
    LAVA_CHANNEL = "lava_channel"
    RUNE_CARVED = "rune_carved"
    HEARTH = "hearth"
    BREWING_VAT = "brewing_vat"
    STAGE = "stage"
    ARMORY = "armory"
